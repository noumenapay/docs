...
The QR code was generated by **Microwokers**, and displayed on the **Microworkers** web platform contains the following data-
...
> After download ONTO, Please scan the QR code in "My" -> "NPay" -> "Receive" button.
